...
<div class="box box-solid box-danger">
  ...
  <div class="box-body">
    ...
    <div class="col-md-6" style="padding-bottom:9 ;">
        <button class="form-control btn btn-primary" onclick="kategori_tambah()"><i class="glyphicon glyphicon-plus-sign"></i> Tambah Data</button>
    </div>
    </div>
...
$(document).ready(function() {
    dataTable = $('#table').DataTable( {
      ...
      "ajax":{
        url :"<?= base_url('admin/masterbuku/kategori_list'); ?>",
        type: "post",
        error: function(){ 
          $(".my-grid-error").html("");
