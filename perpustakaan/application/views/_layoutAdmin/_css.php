...
<link rel="stylesheet" href="<?= base_url(); ?>assets/admin/eksternal/font-awesome.min.css">
<link rel="stylesheet" href="<?= base_url(); ?>assets/admin/eksternal/ionicons.min.css">
